...
import { createCategoryServices, getcategoryServices, updateCategoryServices } from '../thunk/categoryServices';
...
const categorySlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(getcategoryServices.fulfilled, (state, action) => {
            return { ...state, loading: false, categoryList: action.payload.result };
        });
