...
function MenuCreationList() {
  ...
  console.log("tytused", allMeanuList);
  ...
  return (
    <div>
      ...
      <div className="bg-red-400 gap-4 wrap flex">
        {[1, 1, 1, 5].map(() => {
          return (
            <div
              class="sm:first:col-span-2 py-14 px-11 rounded-lg max-w-lg w-[40%] h-2"
            ...
            >
              ...
              <div class="text-lg text-black leading-[1.8]">
                <p>
                  See how other companies are using Reply, which use cases are
                  there, and how it all works in practice.
                </p>
              </div>
              <ul class="mt-6 sm:mt-10">
                <li class="pt-2 pb-4 mb-2 last:mb-0 border-b border-black border-solid">
                  <a
                    class="flex items-center justify-between text-black hover:text-black text-lg sm:text-xl font-medium"
                    href="#"
                  >
