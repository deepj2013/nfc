...
<div className="flex flex-col md:flex-row justify-between items-start gap-8">
  ...
  <div className="md:w-1/2 space-y-4">
    ...
    <h3 className="text-lg font-semibold">New Friends Club</h3>
    ...
    <p>
      <strong>Email:</strong> 
      <a href="mailto:nfclub94@yahoo.co.in" className="text-blue-500 hover:underline">nfclub94@yahoo.co.in</a>
    </p>
    <p>
      <strong>Website:</strong> 
      <a href="http://www.newfriendsclubdelhi.com" className="text-blue-500 hover:underline" target="_blank">www.newfriendsclubdelhi.com</a>
    </p>
  </div>
