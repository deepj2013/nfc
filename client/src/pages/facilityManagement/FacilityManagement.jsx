      ...
      <div className="flex">
        ...
        <div className="w-3/4 p-4">
          ...
          <div className="grid grid-cols-7 gap-2 mb-4">
            { 
              menu?.timings[0].days?.map((ele,ind)=>{
                return(
                  <div key={ind} className="bg-gray-100 p-1 rounded text-center">
              <p className="font-semibold text-sm">{dayName[ele]}</p>
              <p className="text-[7px] text-gray-600">{menu?.timings[0].openingTime}- {menu?.timings[0].closingTime}</p>
            </div>
                )
              })
            }
