                                    ...
                                    <table class="table-auto min-w-full rounded-xl">
                                        <thead>
                                            <tr class="bg-gray-50">
                                                ...
                                                <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Unit Name </th>
                                                <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Short Name </th>
                                                ...
                                                unitList.map((ele, ind) => {
                                                    return (
                                                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                                            ...
                                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{ele?.unitName}</td>

                                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {ele?.abbreviation}</td>
