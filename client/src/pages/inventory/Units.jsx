...
function Units() {
    ...
    const getHandler = async () => {
        try {
            let response = await dispatch(getMeasurementUnitsServices()).unwrap()
        } catch (error) {
            logger(error)
        }
    }
    ...
    return (
        <div>
            <div className='mb-6 flex items-center justify-between'>
                <p className='font-semibold h28'>Units</p>
                                    ...
                                    <table className="table-auto min-w-full rounded-xl">
                                        <thead>
                                            <tr className="bg-gray-50">
                                                ...
                                                <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Unit Name </th>
                                                <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Short Name </th>
                                                ...
                                                unitList.map((ele, ind) => {
                                                    return (
                                                        <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                                                            ...
                                                            <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{ele?.unitName}</td>

                                                            <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {ele?.abbreviation}</td>
            ...
            <AddUnit type={type} selectedItem={selectedItem} isOpen={isOpen}
                onClose={() => {
                    setIsOpen(false)
                }}
            />
