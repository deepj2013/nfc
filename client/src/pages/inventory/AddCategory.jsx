    ...
    return (
        <div>
            <div className='mb-6 flex items-center justify-between'>
                <p className='font-semibold h28'>Add Category</p>
                                    ...
                                    <table className="table-auto min-w-full rounded-xl">
                                        <thead>
                                            <tr className="bg-gray-50">
                                                ...
                                                <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Category Name </th>
                                                <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Total Products </th>
                                                ...
                                                categoryList.map((ele, ind) => {
                                                    ...
                                                    return (
                                                        <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                                                            ...
                                                            <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{ind + 1} </td>
                                                            <td className=" px-5 py-3">
                                                                <div className="w-48 flex items-center gap-3">
                                                                    <div className="data">
                                                                        <p className="font-normal text-sm text-gray-900">{ele?.categoryName}</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{ele?.description}</td>
