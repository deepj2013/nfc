        ...
        <div>
            <div className='mb-6 flex items-center justify-between'>
                ...
                <div className='flex gap-4'>
                    ...
                    <Button
                        onClick={()=>{
                            navigate('/add-vender',{state: {type}})
                        }}
                        rigntIcon={<IoAddCircleSharp className='text-2xl' />}
                        name={'Add Vendor'} />
                </div>
                  ...
                  <table className="table-auto min-w-full rounded-xl">
                      <thead>
                          <tr className="bg-gray-50">
                              ...
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Id </th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> vendorName </th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> vendor </th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> contactPerson </th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> contactEmail </th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> contactPhone </th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> gstNumber</th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">address</th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> productsSupplied</th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> paymentTerms</th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> createdBy</th>
                              <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Action</th>
                          </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-300 ">
                        {
                            allVenderList.map((ele,ind)=>{
                                ...
                                return(
                                    ...
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"><p className="font-normal text-sm text-gray-900">{ind+1} </p></td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "><p className="font-normal text-sm text-gray-900">{ele?.vendorName}</p></td>
                                    <td className=" px-5 py-3">
                                                <p className="font-normal text-sm text-gray-900">{ele?.vendor}</p>
                                    </td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">  
                                                <p className="font-normal text-sm text-gray-900">{ele?.contactPerson}</p>
                                    </td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> <p className="font-normal text-sm text-gray-900"> {ele?.contactEmail}</p></td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"><p className="font-normal text-sm text-gray-900">{ele?.contactPhone}</p></td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"><p className="font-normal text-sm text-gray-900">
                                        {ele?.gstNumber}</p>
                                    </td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"><p className="font-normal text-sm text-gray-900">
                                        {`${ele?.address?.street},${ele?.address?.city},${ele?.address?.state},${ele?.address?.country},${ele?.address?.postalCode}`}</p>
                                    </td>
                                    <td className="flex p-5 items-center gap-0.5"><p className="font-normal text-sm text-gray-900">
                                        {ele?.productsSupplied.length>0 && productsSupplied.map((ele)=>{<p className="flex p-5 items-center gap-0.5">{ele}</p>})}</p>
                                    </td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"><p className="font-normal text-sm text-gray-900">{ele?.paymentTerms} </p></td>
                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"><p className="font-normal text-sm text-gray-900"> {ele?.createdBy} </p></td>
                                    <td className="flex p-5 items-center gap-0.5">
                                                                ...
                                                                onClick={()=>{
                                                                    setSelectedItem(ele)
                                                                    navigate('/add-vender',{ state: {item:ele, type:"edit"}})
                                                                }}
                                                                >
