...
import { GENDER_DATA, errorToast, logger, successToast, validateFields } from "../../utils/Helper";
import Button from "../../components/common/Button";

import { addDependentServices, addDepositServices } from "../../redux/thunk/useMangementServices";
...
const AddDependent = ({
    ...
    const addDepositeHandler = async () => {
        ...
        try {
            let response = await dispatch(addDependentServices({ id: memberId, payload: formData })).unwrap();
    ...
    return (
        ...
        >
            ...
            ></div>
            <div
                className={`bg-white  w-[95vw] px-4 lg:w-[500px] py-4 rounded-lg h-[95vh] lg:h-auto  shadow-xl transform transition-transform duration-300 ${isOpen ? "translate-y-0" : "translate-y-full"
                    }`}
